...
import Policies from "@/app/ui/product/policies";
...
export default async function ProductDetail({params}:{
  ...
  return(
    <>
      ...
      <div className={`${lato.className} text-gray-700 body-font overflow-hidden bg-white`}>
        ...
        <div className="flex flex-col container px-5 py-20 mx-auto bg-amber-100 my-10">
          <h1 className={`${patrick_hand.className} text-center text-3xl text-black`}>Latest Reviews</h1>
          <div className="ml-5">
            <ProductRating id={productSelected.product_id}/>
          </div>
