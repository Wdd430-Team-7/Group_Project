...
export default async function ProductDetail({
  ...
  const ratingsProduct: ProductRating[] = ratingsProductRaw.map(
    (row: QueryResultRow) => ({
    ...
    <>
      <div className="text-gray-700 body-font overflow-hidden bg-white">
        <div className="container px-5 py-24 mx-auto bg-amber-100 mt-10">
          <div className="mx-auto flex flex-wrap space-x-20 justify-center">
            <Image
              ...
              src={`${productSelected.product_image}`}
              alt=""
              width={400}
              height={400}
            />
            <div className="text-center mt-10">
              <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">
                {productSelected.product_title}
              </h1>
              <ProductRating id={productSelected.product_id} />
              <p className="leading-relaxed">
                {productSelected.product_description}
              </p>
              ...
              <div className="flex">
                ...
                <button className="flex ml-auto text-white bg-amber-400 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded">
                  Button
                </button>
              </div>
            </div>
        ...
        <div className=" flex flex-col container px-5 py-5 mx-auto bg-white mt-10">
          <h2 className="text-center text-gray-900 text-2xl title-font font-medium mb-1">
            write a review about this product
          </h2>

          <p className="text-center">Share your opinion with other artisans</p>
          <Link
            href={`/product/details/${productSelected.product_id}/reviews/${productSelected.artist_id}`}
            className="mr-auto ml-auto text-white bg-gray-400 border-0 py-2 px-6 focus:outline-none hover:bg-amber-400 rounded"
          >
            write your opinion
          </Link>
        </div>
